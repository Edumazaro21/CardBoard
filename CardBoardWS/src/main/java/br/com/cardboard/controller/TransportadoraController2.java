...
@RestController
@RequestMapping("/consultartransportadora2")
public class TransportadoraController2 {
    ...
    private String getTransportadora(Long id) throws Exception {
        ...
        try {
            ...
            rst = stm.executeQuery("SELECT tempomedio, valor FROM transportadora WHERE id_transportadora = 2 AND id_tipotransporte = " + id);
